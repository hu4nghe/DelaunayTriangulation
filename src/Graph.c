...
{
    return 0.5*((t.b.x*t.c.y-t.c.x*t.b.y)-(t.a.x*t.c.y-t.c.x*t.a.y)+(t.a.x*t.b.y-t.b.x*t.a.y));
}
...
{  
    double a1 = t.b.x - t.a.x, b1 = t.b.y - t.a.y, c1 = (a1*a1 + b1*b1)/2;  
    double a2 = t.c.x - t.a.x, b2 = t.c.y - t.a.y, c2 = (a2*a2 + b2*b2)/2;  
    double d = a1 * b2 - a2 * b1;

    point centre;
    pointInit(&centre,t.a.x + (c1*b2 - c2*b1)/d,t.a.y + (a1*c2 - a2*c1)/d);  
  
    circle c;
    circleInit(&c,centre,Distance(centre, t.a));
    return c; 
}
